...
public class Paciente {
    ...
    public Paciente(String nombre, String aPaterno, String aMaterno, String curp, String fechaNac, char sexo, String email) {
    ...
    public String toString() {
        return String.format("Paciente: %s %s %s\nCURP: %s\nFecha Nac: %s\nSexo: %c\nEmail: %s",
                nombre, aPaterno, aMaterno, curp, fechaNac, sexo, email);
    }
}